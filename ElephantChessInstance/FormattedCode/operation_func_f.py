...
[r['append'], [r['reg'], obj(4), []], [r['call'], cid_of['func::compare_concepts'],
[
[r['get_member'], [r['find'], [r['reg'], obj(1), []], [r['call'], cid_of['func::logic_and'],
[
[r['call'], cid_of['func::math_equal'],
[
[r['at'], [r['get_member'], [r['target']], cid_of['xq::position']], [obj(0)]],
...
[r['assign_as_reference'], [r['reg'], obj(5), []], [r['find'], [r['reg'], obj(1), []], [r['call'], cid_of['func::logic_and'],
[
[r['call'], cid_of['func::math_equal'],
[
[r['at'], [r['get_member'], [r['target']], cid_of['xq::position']], [obj(0)]],
...
[
[r['get_member'], [r['reg'], obj(5), []], cid_of['xq::piece_name']],
[r['concept_instance'], cid_of['xq::Ma']]
]
],
[
[r['request'],
...
[
[r['get_member'], [r['reg'], obj(5), []], cid_of['xq::piece_name']],
[r['concept_instance'], cid_of['xq::Xiang']]
]
],
[
[r['request'],
...
[
[r['assign'], [r['get_member'], [r['reg'], obj(0), []], cid_of['xq::whose_turn']], [r['concept_instance'], cid_of['xq::black_team']]]
],
[],
[
[r['assign'], [r['get_member'], [r['reg'], obj(0), []], cid_of['xq::whose_turn']], [r['concept_instance'], cid_of['xq::red_team']]]
]
], 
