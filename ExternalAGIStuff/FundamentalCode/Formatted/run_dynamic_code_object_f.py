...
[r['assign_as_reference'], [r['reg'], obj(0), []], [r['concept_instance'], cid_of['dc::runtime_inputs']]], 
[r['for'], obj(0), [r['size'], [r['input'], obj(1)]],
[
[r['assign_as_reference'], [r['reg'], obj(1), [[r['iterator'], obj(0)]]], [r['concept_instance'], cid_of['dc::input_container']]], 
[r['assign_as_reference'], [r['get_member'], [r['reg'], obj(1), [[r['iterator'], obj(0)]]], cid_of['dc::index']], [r['iterator'], obj(0)]], 
[r['assign_as_reference'], [r['get_member'], [r['reg'], obj(1), [[r['iterator'], obj(0)]]], cid_of['value']], [r['at'], [r['input'], obj(1)], [r['iterator'], obj(0)]]], 
[r['append'], [r['reg'], obj(0), []], [r['reg'], obj(1), [[r['iterator'], obj(0)]]]]
]
], 
[r['assign_as_reference'], [r['reg'], obj(2), []], [r['concept_instance'], cid_of['dc::runtime_registers']]], 
[r['assign_as_reference'], [r['reg'], obj(3), []], [r['concept_instance'], cid_of['dc::runtime_iterators']]], 
[r['assign_as_reference'], [r['reg'], obj(4), []], [r['concept_instance'], cid_of['dc::runtime_memory']]], 
...
[
[r['assign_as_reference'], [r['reg'], obj(5), [[r['iterator'], obj(1)]]], [r['call'], cid_of['func::process_line'],
[
